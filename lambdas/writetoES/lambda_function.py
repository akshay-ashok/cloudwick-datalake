...
#from lambdas3dynamo import data_handler
import urllib
import json
...
def lambda_handler(event, context):
    ...
    if filter_key == "CloudTrailLogs/" or filter_key == "TaskRunnerLogs/":
        print("skipped logging for cloudtrail logs and taskrunner logs")
    else:
        try:
