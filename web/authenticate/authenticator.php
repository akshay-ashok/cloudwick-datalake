    ...
    if(isset($_POST["formSource"])){
        ...
        try {
            ...
            if ($result->rowCount() > 0) {
                ...
                $_SESSION["DatalakeUser"] = $username;
                $_SESSION["lastActivity"] = time();
                print '<div class="alert alert-success">
                        Login Successful <a href="../home/">click here</a> if not redirected
                       </div>';
            } else {
                print '<div class="alert alert-warning">
            ...
            if ($result->rowCount() > 0) {
                ...
                if($cp->rowCount() > 0){
                    ...
                    $message = "Hello ".$username.",<br>
                                At your request, we have reset your password. 
                    ...
                    if($sent == true){
                        print '<div class="alert alert-success">
                                Password emailed to '.$email.'. Check your inbox/spam for new password !!
                               </div>';
                    } else {
                        print '<div class="alert alert-success">
                                Email to '.$email.' failed. Your new Password is '.$newpass.'
                               </div>';
                    }
        ...
        try {
            ...
            if ($result->rowCount() > 0) {
                ...
                print '<div class="alert alert-danger">
                        Specified user/password combination incorrect
                       </div>';
            }
        } catch(PDOException $ex){
            print $ex->getMessage();
        ...
        // todo: handle unauthorised access to script
        // -- susheel 04/07/2017
        print '<div class="alert alert-danger">
                Action not allowed at the moment
               </div>';
    }
